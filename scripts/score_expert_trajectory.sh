...
apptainer exec --nv \
  ...
  bash -lc '
    ...
    python score_expert_trajectory.py \
      ...
      --model_dir "/scratch1/haobaizh/rlvlmf_online_logs/gt_reward_draweropen/metaworld_drawer-open-v2/2026-04-07-03-57-41/vlm_0bard_rewardgt_task_reward_H256_L3_lr0.0003/teacher_b-1_g1_m0_s0_e0/label_smooth_0.0/schedule_0/PEBBLE_init1000_unsup9000_inter5000_maxfeed20000_seg50_acttanh_Rlr0.0001_Rbatch100_Rupdate30_en3_sample0_large_batch10_seed0/models" \
      --step '"$ACTOR_STEP"' \
      --reward_model_dir "/scratch1/haobaizh/rlvlmf_online_logs/baseline_smooth_gemini_freeform_1M_noterminate_seed0_draweropen/metaworld_drawer-open-v2/2026-04-03-13-52-49/vlm_1gemini_free_form_rewardlearn_from_preference_H256_L3_lr0.0003/teacher_b-1_g1_m0_s0_e0/label_smooth_0.0/schedule_0/PEBBLE_init1000_unsup9000_inter4000_maxfeed20000_seg1_acttanh_Rlr0.0003_Rbatch40_Rupdate10_en3_sample0_large_batch10_seed0/models" \
      --reward_model_step 900000 \
      --ensemble_size '"$ENSEMBLE_SIZE"' \
      --seed '"$SEED"' \
      --max_steps '"$MAX_STEPS"' \
      --image_size '"$IMAGE_SIZE"' \
      --output_dir "'"$OUTPUT_ROOT"'/draweropen"

    python score_expert_trajectory.py \
      --env "metaworld_soccer-v2" \
      --model_dir "/scratch1/haobaizh/rlvlmf_online_logs/gt_reward_soccer/metaworld_soccer-v2/2026-04-07-03-57-03/vlm_0bard_rewardgt_task_reward_H256_L3_lr0.0003/teacher_b-1_g1_m0_s0_e0/label_smooth_0.0/schedule_0/PEBBLE_init1000_unsup9000_inter5000_maxfeed20000_seg50_acttanh_Rlr0.0001_Rbatch100_Rupdate30_en3_sample0_large_batch10_seed0/models" \
      --step '"$ACTOR_STEP"' \
      --reward_model_dir "/scratch1/haobaizh/rlvlmf_online_logs/baseline_gemini_freeform_1M_noterminate_seed0_soccer/metaworld_soccer-v2/2026-04-05-01-05-55/vlm_1gemini_free_form_rewardlearn_from_preference_H256_L3_lr0.0003/teacher_b-1_g1_m0_s0_e0/label_smooth_0.0/schedule_0/PEBBLE_init1000_unsup9000_inter4000_maxfeed20000_seg1_acttanh_Rlr0.0001_Rbatch40_Rupdate5_en3_sample0_large_batch10_seed0/models" \
      --reward_model_step 300000 \
      --ensemble_size '"$ENSEMBLE_SIZE"' \
      --seed '"$SEED"' \
      --max_steps '"$MAX_STEPS"' \
      --image_size '"$IMAGE_SIZE"' \
      --output_dir "'"$OUTPUT_ROOT"'/soccer"
    ...
    python score_expert_trajectory.py \
      ...
      --max_steps '"$MAX_STEPS"' \
      --image_size '"$IMAGE_SIZE"' \
      --output_dir "'"$OUTPUT_ROOT"'/sweepinto"
  '
