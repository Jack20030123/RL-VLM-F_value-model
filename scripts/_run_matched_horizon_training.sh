...
: "${RLVLMF_SMOOTH_WINDOW:=}"
: "${RLVLMF_VIDEO_STEP_INTERVAL:=}"
: "${RLVLMF_VIDEO_STEP_OFFSET:=}"
export RLVLMF_USE_SMOOTH_RELABEL RLVLMF_SMOOTH_WINDOW RLVLMF_VIDEO_STEP_INTERVAL RLVLMF_VIDEO_STEP_OFFSET
...
if [ -n "$RLVLMF_SMOOTH_WINDOW" ]; then
  cmd+=(smooth_window="$RLVLMF_SMOOTH_WINDOW")
fi
